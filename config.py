...
config_mixed_coco14_coco14_Xception_glove_lstm512 = {
    "train": {"dataset_name": "coco14", "subset_name": "train"},
    ...
    "model_save_dir": "/model_weights",
    "model_save_path": "/model_Base_3_Batch_Komninos.h5",
    "data_name": "mixed_coco14_coco14_Xception_glove_lstm512",
    "images_processor": "Xception",
    "text_processor": "glove",
    "continue_training": True
}
config_mixed_coco14_coco14_Xception_glove_lstm128 = {
    "train": {"dataset_name": "coco14", "subset_name": "train"},
    "test": {"dataset_name": "coco14", "subset_name": "test"},
    "encode_images": False,
    "save_ix_to_word": False,
    ...
    "model_save_dir": "/model_weights",
    "model_save_path": "/model_Base_3_Batch_Komninos.h5",
    "data_name": "mixed_coco14_coco14_Xception_glove_lstm128",
    "images_processor": "Xception",
    "text_processor": "glove",
    "continue_training": True
}
config_mixed_coco14_coco14_Xception_glove_img128_lstm128 = {
    "train": {"dataset_name": "coco14", "subset_name": "train"},
    "test": {"dataset_name": "coco14", "subset_name": "test"},
    "encode_images": False,
    "save_ix_to_word": False,
    ...
    "model_save_dir": "/model_weights",
    "model_save_path": "/model_Base_3_Batch_Komninos.h5",
    "data_name": "mixed_coco14_coco14_Xception_glove_img128_lstm128",
    "images_processor": "Xception",
    "text_processor": "glove",
    "continue_training": True
}
config_mixed_coco14_coco14_Xception_glove_img256_lstm256 = {
    "train": {"dataset_name": "coco14", "subset_name": "train"},
    "test": {"dataset_name": "coco14", "subset_name": "test"},
    "encode_images": False,
    "save_ix_to_word": False,
    ...
    "model_save_dir": "/model_weights",
    "model_save_path": "/model_Base_3_Batch_Komninos.h5",
    "data_name": "mixed_coco14_coco14_Xception_glove_img256_lstm256",
    "images_processor": "Xception",
    "text_processor": "glove",
    "continue_training": True
}
config_mixed_coco14_coco14_Xception_glove_img512_lstm512 = {
    "train": {"dataset_name": "coco14", "subset_name": "train"},
    "test": {"dataset_name": "coco14", "subset_name": "test"},
    "encode_images": False,
    "save_ix_to_word": False,
    ...
    "model_save_dir": "/model_weights",
    "model_save_path": "/model_Base_3_Batch_Komninos.h5",
    "data_name": "mixed_coco14_coco14_Xception_glove_img512_lstm512",
    "images_processor": "Xception",
    "text_processor": "glove",
    "continue_training": True
}
config_mixed_coco14_coco14_Xception_glove_img512_lstm512_noDense = {
    "train": {"dataset_name": "coco14", "subset_name": "train"},
    "test": {"dataset_name": "coco14", "subset_name": "test"},
    "encode_images": False,
    "save_ix_to_word": False,
    ...
    "model_save_dir": "/model_weights",
    "model_save_path": "/model_Base_3_Batch_Komninos.h5",
    "data_name": "mixed_coco14_coco14_Xception_glove_img512_lstm512_noDense",
    "images_processor": "Xception",
    "text_processor": "glove",
    "continue_training": True
}
config_mixed_coco14_coco14_Xception_glove_img512_lstm512_withDense = {
    "train": {"dataset_name": "coco14", "subset_name": "train"},
    "test": {"dataset_name": "coco14", "subset_name": "test"},
    "encode_images": False,
    "save_ix_to_word": False,
    ...
    "model_save_dir": "/model_weights",
    "model_save_path": "/model_Base_3_Batch_Komninos.h5",
    "data_name": "mixed_coco14_coco14_Xception_glove_img512_lstm512_withDense",
    "images_processor": "Xception",
    "text_processor": "glove",
    "continue_training": True
}
config_mixed_coco14_coco14_Xception_glove_concatenate_dense512 = {
    "train": {"dataset_name": "coco14", "subset_name": "train"},
    "test": {"dataset_name": "coco14", "subset_name": "test"},
    "encode_images": False,
    "save_ix_to_word": False,
    ...
    "model_save_dir": "/model_weights",
    "model_save_path": "/model_Base_3_Batch_Komninos.h5",
    "data_name": "mixed_coco14_coco14_Xception_glove_concatenate_dense512",
    "images_processor": "Xception",
    "text_processor": "glove",
    "continue_training": False
}
config_mixed_coco14_coco14_Xception_glove_concatenate_dense512_GRU = {
    "train": {"dataset_name": "coco14", "subset_name": "train"},
    "test": {"dataset_name": "coco14", "subset_name": "test"},
    "encode_images": False,
    "save_ix_to_word": False,
    ...
    "model_save_dir": "/model_weights",
    "model_save_path": "/model_Base_3_Batch_Komninos.h5",
    "data_name": "mixed_coco14_coco14_Xception_glove_concatenate_dense512_GRU",
    "images_processor": "Xception",
    "text_processor": "glove",
    "continue_training": False
}
...
config_mixed_coco14_coco14_Xception_glove_concatenate_dense256 = {
    ...
    "model_save_dir": "/model_weights",
    "model_save_path": "/model_Base_3_Batch_Komninos.h5",
    "data_name": "mixed_coco14_coco14_Xception_glove_concatenate_dense256",
    "images_processor": "Xception",
    "text_processor": "glove",
    "continue_training": True
}
config_mixed_coco14_coco14_Xception_glove_concatenate_dense128 = {
    "train": {"dataset_name": "coco14", "subset_name": "train"},
    "test": {"dataset_name": "coco14", "subset_name": "test"},
    "encode_images": False,
    "save_ix_to_word": False,
    ...
    "model_save_dir": "/model_weights",
    "model_save_path": "/model_Base_3_Batch_Komninos.h5",
    "data_name": "mixed_coco14_coco14_Xception_glove_concatenate_dense128",
    "images_processor": "Xception",
    "text_processor": "glove",
    "continue_training": True
}
config_mixed_coco14_coco14_Xception_glove_img128_lstm128_withDense = {
    "train": {"dataset_name": "coco14", "subset_name": "train"},
    "test": {"dataset_name": "coco14", "subset_name": "test"},
    "encode_images": False,
    "save_ix_to_word": False,
    ...
    "model_save_dir": "/model_weights",
    "model_save_path": "/model_Base_3_Batch_Komninos.h5",
    "data_name": "mixed_coco14_coco14_Xception_glove_img128_lstm128_withDense",
    "images_processor": "Xception",
    "text_processor": "glove",
    "continue_training": True
}
...
config_mixed_coco14_coco14_Xception_glove_noDense = {
    "train": {"dataset_name": "coco14", "subset_name": "train"},
    "test": {"dataset_name": "coco14", "subset_name": "test"},
    "encode_images": False,
    "save_ix_to_word": False,
    ...
    "model_save_dir": "/model_weights",
    "model_save_path": "/model_Base_3_Batch_Komninos.h5",
    "data_name": "mixed_coco14_coco14_Xception_glove_noDense",
    "images_processor": "Xception",
    "text_processor": "glove",
    "continue_training": True
}
config_mixed_coco14_coco14_Xception_glove_img128_lstm128_noDense = {
    "train": {"dataset_name": "coco14", "subset_name": "train"},
    "test": {"dataset_name": "coco14", "subset_name": "test"},
    "encode_images": False,
    "save_ix_to_word": False,
    ...
    "model_save_dir": "/model_weights",
    "model_save_path": "/model_Base_3_Batch_Komninos.h5",
    "data_name": "mixed_coco14_coco14_Xception_glove_img128_lstm128_noDense",
    "images_processor": "Xception",
    "text_processor": "glove",
    "continue_training": False
}
...
config_mixed_coco14_flickr30k_vgg16_glove = {
    "train": {"dataset_name": "coco14", "subset_name": "train"},
    "test": {"dataset_name": "flickr30k", "subset_name": "train"},
    "encode_images": False,
    "save_ix_to_word": False,
    "train_model": False,
    "save_model": False,
...
config_mixed_coco14_flickr30k_denseNet121_glove = {
    "train": {"dataset_name": "coco14", "subset_name": "train"},
    "test": {"dataset_name": "flickr30k", "subset_name": "train"},
    "encode_images": False,
    "save_ix_to_word": False,
    ...
    "model_save_dir": "/model_weights",
    "model_save_path": "/model_Base_3_Batch_Komninos.h5",
    "data_name": "mixed_coco14_flickr30k_denseNet121_glove",
    "images_processor": "denseNet121",
    "text_processor": "glove",
    "continue_training": False
}
config_mixed_coco14_flickr30k_denseNet121_fastText = {
    "train": {"dataset_name": "coco14", "subset_name": "train"},
    "test": {"dataset_name": "flickr30k", "subset_name": "train"},
    "encode_images": False,
    "save_ix_to_word": False,
    ...
    "model_save_dir": "/model_weights",
    "model_save_path": "/model_Base_3_Batch_Komninos.h5",
    "data_name": "mixed_coco14_flickr30k_denseNet121_fastText",
    "images_processor": "denseNet121",
    "text_processor": "fastText",
    "continue_training": False
}

config_mixed_coco14_flickr30k_denseNet201_glove = {
    "train": {"dataset_name": "coco14", "subset_name": "train"},
    "test": {"dataset_name": "flickr30k", "subset_name": "train"},
    "encode_images": False,
    "save_ix_to_word": False,
    ...
    "model_save_dir": "/model_weights",
    "model_save_path": "/model_Base_3_Batch_Komninos.h5",
    "data_name": "mixed_coco14_flickr30k_denseNet201_glove",
    "images_processor": "denseNet201",
    "text_processor": "glove",
    "continue_training": False
}
config_mixed_coco14_flickr30k_denseNet201_fastText = {
    "train": {"dataset_name": "coco14", "subset_name": "train"},
    "test": {"dataset_name": "flickr30k", "subset_name": "train"},
    "encode_images": False,
    "save_ix_to_word": False,
    ...
    "model_save_dir": "/model_weights",
    "model_save_path": "/model_Base_3_Batch_Komninos.h5",
    "data_name": "mixed_coco14_flickr30k_denseNet201_fastText",
    "images_processor": "denseNet201",
    "text_processor": "fastText",
    "continue_training": False
}

config_mixed_coco14_flickr30k_mobileNet_glove = {
    "train": {"dataset_name": "coco14", "subset_name": "train"},
    "test": {"dataset_name": "flickr30k", "subset_name": "train"},
    "encode_images": False,
    "save_ix_to_word": False,
    ...
    "model_save_dir": "/model_weights",
    "model_save_path": "/model_Base_3_Batch_Komninos.h5",
    "data_name": "mixed_coco14_flickr30k_mobileNet_glove",
    "images_processor": "mobileNet",
    "text_processor": "glove",
    "continue_training": False
}
config_mixed_coco14_flickr30k_mobileNet_fastText = {
    "train": {"dataset_name": "coco14", "subset_name": "train"},
    "test": {"dataset_name": "flickr30k", "subset_name": "train"},
    "encode_images": False,
    "save_ix_to_word": False,
...
config_mixed_coco14_flickr30k_mobileNetV2_glove = {
    "train": {"dataset_name": "coco14", "subset_name": "train"},
    "test": {"dataset_name": "flickr30k", "subset_name": "train"},
    "encode_images": False,
    "save_ix_to_word": False,
    ...
    "model_save_dir": "/model_weights",
    "model_save_path": "/model_Base_3_Batch_Komninos.h5",
    "data_name": "mixed_coco14_flickr30k_mobileNetV2_glove",
    "images_processor": "mobileNetV2",
    "text_processor": "glove",
    "continue_training": False
}
config_mixed_coco14_flickr30k_mobileNetV2_fastText = {
    "train": {"dataset_name": "coco14", "subset_name": "train"},
    "test": {"dataset_name": "flickr30k", "subset_name": "train"},
    "encode_images": False,
    "save_ix_to_word": False,
    ...
    "model_save_dir": "/model_weights",
    "model_save_path": "/model_Base_3_Batch_Komninos.h5",
    "data_name": "mixed_coco14_flickr30k_mobileNetV2_fastText",
    "images_processor": "mobileNetV2",
    "text_processor": "fastText",
    "continue_training": False
}
