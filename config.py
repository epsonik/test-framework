...
config_flickr8k_polish = {"images_path": data_path + "images/flickr8k/Images/",
           "train_images_path": data_path + "images/flickr8k_polish/flickr8k_polish_text/flickr8k_polish.trainImages.txt", # file conatains the names of images to be used in train data
           "test_images_path": data_path + "images/flickr8k_polish/flickr8k_polish_text/flickr8k_polish.testImages.txt",
           "train_path": data_path + "images/aide/aide_text/aide.trainImages.txt", 
           "token_path": data_path + "images/flickr8k_polish/flickr8k_polish_text/flickr8k_polish.token.txt",
          "word_embedings_path": data_path + "images/glovePL/glove_100_3_polish.txt",
           "embedings_dim": 99, # Polish - 100
           "train_model": True, # True if you intend to train the model,
           "save_model": True,
...
config_flickr8k_polish = {"images_path": data_path + "images/flickr30k/Images/",
